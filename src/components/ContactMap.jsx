...
export default class ContactMap extends React.Component {
  componentDidMount() {
    ...
    L.marker([40.4166667, -3.7000000], { title: 'Madrid' }).addTo(this.map)
    ...
    L.marker([48.7500000, 2.4500000], { title: 'Paris' }).addTo(this.map)
    ...
    L.marker([-25.2044444, 30.0455556], { title: 'Johannesburg' }).addTo(this.map)
    ...
    L.marker([25.2630556, 55.2972222], { title: 'Dubai' }).addTo(this.map)
